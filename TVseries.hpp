...
class TVSeriesAPP {
private:
    vector<TitleBasics> titleBasics; /** @brief vector with all the TVSeries */
    vector<TitleEpisode> titleEpisodes; /** @brief vector with all the episodes */
    vector<TitlePrincipals> titlePrincipals; /** @brief vector with all the principals */
